<template>
    <VDropdown :distance="10">
        <button type="button" class="flex items-center space-x-2 text-sm">
        ...
        <template #popper="{ hide }">
            <ul class="-space-y-1">
                <li v-for="site in sites" :key="site.id">
                    <Link :href="route('dashboard', site.id)"
                ...
                <li>
                    <button
                        ...
                        class="block w-full text-left px-4 py-2 hover:bg-gray-100 text-indigo-500 font-bold text-sm">Add
                        a site
                    </button>
                </li>
            </ul>
